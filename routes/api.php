...
// Group untuk Broadcast Routes
Route::prefix('broadcasts')->group(function () {
    // Mengirim broadcast ke semua pengguna
    Route::post('/', [BroadcastController::class, 'sendBroadcast']); 
    
    // Mengirim broadcast ke pengguna berdasarkan rentang umur
    Route::post('/age', [BroadcastController::class, 'broadcastByAge']);
});